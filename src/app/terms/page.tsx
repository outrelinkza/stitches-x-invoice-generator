              ...
              <div className="relative animate-enter" style={{animationDelay: '150ms'}}>
                ...
                <div className="h-[60vh] max-h-[800px] overflow-y-auto p-8 rounded-2xl border border-white/20 glass-effect">
                  <div className="prose prose-base max-w-none text-white/80">
                    ...
                    <p>
                      By accessing and using StitchInvoice ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                    </p>

                    <h3 className="text-xl font-semibold text-white mt-8">2. Service Description</h3>
                    <p>
                      StitchInvoice is an AI-powered invoice generation platform that allows users to create, manage, and download professional invoices. Our service includes:
                    </p>
                    ...
                    <p>
                      The service and its original content, features, and functionality are owned by StitchInvoice and are protected by international copyright, trademark, and other intellectual property laws.
                    </p>
                    ...
                    <p>
                      To the maximum extent permitted by law, StitchInvoice shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service.
                    </p>
                    ...
                    <p>
                      For questions about these Terms of Service, please contact us at: <a href="mailto:hello@stitchinvoice.com" className="text-blue-400 hover:text-blue-300">hello@stitchinvoice.com</a>
                    </p>
                  </div>
                </div>
              </div>
